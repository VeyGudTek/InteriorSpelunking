...
public class PropPathInterior : MonoBehaviour
{
    ...
    public void GenerateInteriorPropPath(float left, float right, float forward, float back, float level, List<Neighbor> neighbors)
    {
        LeftBound = left;
        RightBound = right;
